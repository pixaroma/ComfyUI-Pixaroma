class PixaromaRunLog:
    ...
    DESCRIPTION = (
        ...
        "The most recent run is highlighted and the fastest one is marked. Only the "
        "times are shown - no workflow names, no clutter - and the list is for this "
        "workflow only. Right-click the node to copy the times or clear the list.\n\n"
