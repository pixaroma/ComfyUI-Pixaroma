...
// ============================================================
import { CropEditor, RATIOS, SNAPS } from "./core.mjs";
...
proto._handleCursor = function(id) {
    return { tl:"nwse-resize", br:"nwse-resize", tr:"nesw-resize", bl:"nesw-resize", t:"ns-resize", b:"ns-resize", l:"ew-resize", r:"ew-resize" }[id] || "default";
};
