...
// ============================================================
import { ThreeDAPI } from "./api.js";
import { installFocusTrap } from "../shared/index.js";
import {
    BRAND,
    createEditorLayout,
    createPanel,
...
export let THREE = null, OrbitControls = null, TransformControls = null;
...
export {
    ThreeDAPI,
    createEditorLayout, createPanel, createButton, createSliderRow, createRow,
    createNumberInput, createSelectInput, createColorInput, createCheckbox,
    createInfo, createButtonRow, createCanvasSettings, createCanvasFrame,
    createLayerPanel, createLayerItem, createCanvasToolbar, createTransformPanel,
};
